...
class ShopAPITestCase(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.category_2 = Category.objects.create(name='Legumes', active=True)
...
class TestCategory(ShopAPITestCase):
    ...
    def test_list(self):
        ...
        self.assertEqual(response.json()['results'], self.get_product_list_data([self.category, self.category_2]))
